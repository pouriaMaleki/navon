...
class DeviceStatusChipStateTest {
    ...
    fun pairedDisconnected_whenRecordButStateDisconnected() {
        ...
        assertEquals(
            DeviceChipState.PairedDisconnected("ESP32 Bike Minimap"),
            state,
        )
    }
    ...
    fun connecting_whenScanning() {
        ...
        assertEquals(DeviceChipState.Connecting("ESP32 Bike Minimap"), state)
    }
    ...
    fun connected_whenConnectedAndRecordPresent() {
        ...
        assertEquals(DeviceChipState.Connected("ESP32 Bike Minimap"), state)
    }
