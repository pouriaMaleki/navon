...
class FakeRouteSyncBluetoothClient : RouteSyncBluetoothClient {
    ...
    var scanResult: Result<String> = Result.success("Navon")
    var connectResult: Result<String> = Result.success("Navon")
    var connectPairedResult: Result<String> = Result.success("Navon")
    var connectAdvertisedResult: Result<String> = Result.success("Navon")
