...
import app.navon.bike.app.markSharedIntentConsumed
...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var keepScreenOnController: app.navon.bike.integration.screen.KeepScreenOnController
    private var androidTtsService: app.navon.bike.integration.audio.AndroidTtsService? = null
    private var routingCoordinator: app.navon.bike.integration.cues.RoutingActivityCoordinator? = null
    ...
    companion object {
        ...
        /// on teardown.
        internal var ttsPortRef: app.navon.bike.integration.audio.TtsPort? = null
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        app.navon.bike.integration.i18n.Strings.bootstrap(this)
        app.navon.bike.integration.i18n.Strings.setActiveLocale(
            app.navon.bike.integration.i18n.Strings.resolveLocale(appState.settings.language)
        )
        keepScreenOnController = app.navon.bike.integration.screen.KeepScreenOnController(this)
        val tts = app.navon.bike.integration.audio.AndroidTtsService(this)
...
private fun SettingsRootScreen(
    ...
    ScreenColumn(PaddingValues(0.dp)) {
        Row(verticalAlignment = Alignment.CenterVertically) {
            Text(
                app.navon.bike.integration.i18n.Strings.t("settings.hub.title"),
                style = MaterialTheme.typography.headlineSmall,
                modifier = Modifier.weight(1f),
            )
            Button(onClick = onDismiss) {
                Text(app.navon.bike.integration.i18n.Strings.t("common.close"))
            }
        }
        ...
        Button(onClick = onRoutes, modifier = Modifier.fillMaxWidth()) {
            Text(app.navon.bike.integration.i18n.Strings.t("settings.hub.routes"))
        }
        ...
        Button(onClick = onRoutePlanner, modifier = Modifier.fillMaxWidth()) {
            Text(app.navon.bike.integration.i18n.Strings.t("settings.hub.routePlanner"))
        }
...
private fun LocaleSettingsSection(appState: CompanionAppState) {
    ...
    Column(
        ...
        Text(
            app.navon.bike.integration.i18n.Strings.t("settings.language.title"),
            fontWeight = FontWeight.SemiBold,
        )
        ...
        run {
            val resolved = app.navon.bike.integration.i18n.Strings
                .resolveLocale(settings.language)
            val hasVoice = MainActivity.ttsPortRef?.hasVoice(resolved.tag) ?: true
            if (!hasVoice) {
                Text(
                    text = app.navon.bike.integration.i18n.Strings.t(
        ...
        Column(
            ...
            for (option in app.navon.bike.integration.i18n.AppLanguagePref.entries) {
                val label = if (option == app.navon.bike.integration.i18n.AppLanguagePref.SYSTEM) {
                    app.navon.bike.integration.i18n.Strings.t("settings.language.system")
                } else {
                    app.navon.bike.integration.i18n.SupportedLocale
        ...
        Text(
            app.navon.bike.integration.i18n.Strings.t("settings.distanceUnit.title"),
            fontWeight = FontWeight.SemiBold,
        )
        Row(
            ...
            for (option in app.navon.bike.integration.i18n.DistanceUnitPref.entries) {
                ...
                Button(
                    ...
                    Text(app.navon.bike.integration.i18n.Strings.t(labelKey))
                }
            }
        }
    }
...
private fun ActivitySettingsSection(appState: CompanionAppState) {
    ...
    Column(
        ...
        SettingToggleRow(
            ...
            title = app.navon.bike.integration.i18n.Strings.t("settings.activity.keepScreenOn.title"),
            subtitle = app.navon.bike.integration.i18n.Strings.t("settings.activity.keepScreenOn.subtitle"),
        ...
        SettingToggleRow(
            ...
            title = app.navon.bike.integration.i18n.Strings.t("settings.activity.allowBackgroundGps.title"),
            subtitle = app.navon.bike.integration.i18n.Strings.t("settings.activity.allowBackgroundGps.subtitle"),
        ...
        SettingToggleRow(
            ...
            title = app.navon.bike.integration.i18n.Strings.t("settings.activity.audioCues.title"),
            subtitle = if (gpsOn) app.navon.bike.integration.i18n.Strings.t("settings.activity.audioCues.subtitle")
        ...
        SettingToggleRow(
            ...
            title = app.navon.bike.integration.i18n.Strings.t("settings.activity.audioCuesOnlyInBackground.title"),
            subtitle = app.navon.bike.integration.i18n.Strings.t("settings.activity.audioCuesOnlyInBackground.subtitle"),
        ...
        SettingToggleRow(
            ...
            title = app.navon.bike.integration.i18n.Strings.t("settings.activity.liveActivity.title"),
            subtitle = if (gpsOn) app.navon.bike.integration.i18n.Strings.t("settings.activity.liveActivity.subtitle")
            else "Requires GPS in background. Turn that on first.",
