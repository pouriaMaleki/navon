...
data class CompanionSettings(
     ...
     */
    val language: app.navon.bike.integration.i18n.AppLanguagePref =
        app.navon.bike.integration.i18n.AppLanguagePref.SYSTEM,
    /**
     * Distance unit used for both UI labels and spoken voice cues.
     * SYSTEM resolves at format time from the user's region.
     */
    val distanceUnit: app.navon.bike.integration.i18n.DistanceUnitPref =
        app.navon.bike.integration.i18n.DistanceUnitPref.SYSTEM,
)
