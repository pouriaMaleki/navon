...
class AndroidBleRouteSyncClient(
            ...
            val callback = object : ScanCallback() {
                override fun onScanResult(callbackType: Int, result: ScanResult) {
                    ...
                    if (pendingScanContinuation === continuation) {
                        ...
                        continuation.resume(result.device.name ?: "Navon")
                    }
                }
    ...
    override suspend fun connectToScannedPeripheral(): String {
        ...
        onConnectionStateChange?.invoke(DeviceConnectionState.CONNECTING, device.nameOrFallback("Navon"))
        return suspendCancellableCoroutine { continuation ->
    ...
    private val callback = object : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
            ...
            if (cccd != null) {
                ...
                pendingConnectContinuation?.resume(gatt.device.nameOrFallback("Navon"))
                pendingConnectContinuation = null
                onConnectionStateChange?.invoke(DeviceConnectionState.CONNECTED, gatt.device.nameOrFallback("Navon"))
            }
        }
