package app.navon.bike.integration.sample
...
class SampleRoutingAdapter(
    ...
    private fun classifyTurn(deltaDegrees: Double): Pair<RouteManeuverType, String>? {
        ...
        return if (deltaDegrees > 0) RouteManeuverType.SLIGHT_RIGHT to "Slight right" else RouteManeuverType.SLIGHT_LEFT to "Slight left"
    }
